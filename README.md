...
[![License](https://img.shields.io/badge/license-Apache--2.0-blue.svg)](LICENSE) [![Version](https://img.shields.io/badge/version-1.4.1-green.svg)](package.json) [![Bundle Size](https://img.shields.io/badge/bundle%20size-33.1%20KB-brightgreen.svg)](dist/chart.js)
...
- **Performance** -- ~3ms first render, ~0.002ms tick updates, 33.1KB gzipped
- **AI-First** -- Native LLM integration with structured context export
- **Lightweight** -- Only 33.1KB gzipped (zero external dependencies)
