...
[![License](https://img.shields.io/badge/license-Apache--2.0-blue.svg)](LICENSE) [![Version](https://img.shields.io/badge/version-1.5.3-green.svg)](package.json) [![Bundle Size](https://img.shields.io/badge/bundle%20size-39.6%20KB-brightgreen.svg)](dist/chart.js)
...
- **Performance** -- ~3ms first render, ~0.002ms tick updates, 39.6KB gzipped
- **AI-First** -- Native LLM integration with structured context export
- **Lightweight** -- Only 39.6KB gzipped (zero external dependencies)
