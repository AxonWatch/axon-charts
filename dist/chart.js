...
var AxonCharts = (() => {
  ...
  function validateOptions(options) {
    ...
    if (options.timeframe !== void 0) {
      validateTimeframe(options.timeframe);
    }
    if (options.maxBars !== void 0) {
    ...
    if (options.devicePixelRatio !== void 0) {
  ...
  function validateLayout(layout, path = "layout") {
    ...
    if (layout.padding !== void 0) {
      validatePadding(layout.padding, `${path}.padding`);
    }
  }
  function validateGrid(grid, path = "grid") {
  ...
  function validatePriceFormat(format, path) {
    ...
    if (format.formatter !== void 0 && typeof format.formatter !== "function") {
      throw new ValidationError(`${path}.formatter`, "Formatter must be a function", format.formatter);
    }
  }
  function validateCurrentPrice(currentPrice, path) {
  ...
  function validateBehavior(behavior, path = "behavior") {
  ...
  function validateWidth(value, path) {
  ...
  function validatePadding(padding, path) {
    ...
    for (const field of fields) {
      if (padding[field] !== void 0) {
        if (typeof padding[field] !== "number" || padding[field] < 0 || padding[field] > 1e3) {
          throw new ValidationError(`${path}.${field}`, "Padding must be a number between 0 and 1000", padding[field]);
        }
      }
    }
  }
  function validateColor(color, path) {
